  ...
  en: {
    diagnostics: {
      ...
      readme: [
        ...
        '',
        'Contents:',
        '- diagnostics.json: issue description, version, runtime state, dashboard, settings, sharing status, support/update endpoints, paths, and network environment (Wi-Fi SSID, network interfaces)',
  ...
  'zh-Hans': {
    diagnostics: {
      ...
      readme: [
        ...
        '',
        '包含内容：',
        '- diagnostics.json：问题描述、版本、运行时状态、dashboard、设置、共享状态、支持/更新端点、路径与网络环境（WiFi SSID、网卡列表）',
  ...
  'zh-Hant': {
    diagnostics: {
      ...
      readme: [
        ...
        '',
        '包含內容：',
        '- diagnostics.json：問題描述、版本、執行狀態、dashboard、設定、共享狀態、支援/更新端點、路徑與網路環境（Wi-Fi SSID、網路介面列表）',
